#ifndef __Oracle_Dao_H__
#define __Oracle_Dao_H__
...
static unsigned int sqlctx = 9867;
...
{12,4130,1,0,0,
5,0,0,1,0,0,27,31,0,0,4,4,0,1,0,1,97,0,0,1,97,0,0,1,10,0,0,1,10,0,0,
36,0,0,2,53,0,3,47,0,0,6,6,0,1,0,1,3,0,0,1,97,0,0,1,97,0,0,1,3,0,0,1,3,0,0,1,3,
0,0,
75,0,0,3,0,0,29,48,0,0,0,0,0,1,0,
90,0,0,4,0,0,32,57,0,0,0,0,0,1,0,
};
...

{
  ...
  sqlstm.sqladtp = &sqladt;
  sqlstm.sqltdsp = &sqltds;
  sqlstm.stmt = "insert into logfile  values (:b0,:b1,:b2,:b3,:b4,:b5)";
  ...
  sqlstm.sqhstv[3] = (         void  *)&logintime;
